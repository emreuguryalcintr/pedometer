...
class WaveCustomLCPI extends StatefulWidget {
  final double value;
  final Color color;
  final Axis direction;
  final AnimationController animationController;

  const WaveCustomLCPI({
    Key key,
    @required this.value,
    @required this.color,
  ...
  @override
  _WaveCustomLCPIState createState() => _WaveCustomLCPIState();
}

class _WaveCustomLCPIState extends State<WaveCustomLCPI> with SingleTickerProviderStateMixin {
