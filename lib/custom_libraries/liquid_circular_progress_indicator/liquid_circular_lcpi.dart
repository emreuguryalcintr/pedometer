...
import 'package:denemee/custom_libraries/liquid_circular_progress_indicator/wave_lcpi.dart';
...
class LiquidCircularProgressIndicatorCustomLCPI extends ProgressIndicator {
  ...
  LiquidCircularProgressIndicatorCustomLCPI({
    Key key,
    double value = 0.5,
...
class _LiquidCircularProgressIndicatorState
    extends State<LiquidCircularProgressIndicatorCustomLCPI> {
  @override
...
class _CircleClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    final path = Path()
      ..addArc(Offset.zero & size, 0, _sweep);
    return path;
  }
